...
describe('FinalSwap', () => {
  ...
  beforeAll(async () => {
    ...
    if (!rpcUrl) {
      console.warn('SOLANA_RPC_URL environment variable is not set for parse-finalswap.test.ts. Using a public RPC. This may lead to rate limiting or instability.');
